...
- [4 Реализация системы моделирования](#4-реализация-системы-моделирования)
    ...
    - [4.4 Интеграция с симулятором Verilog](#44-интеграция-с-симулятором-verilog)
...
В данной работе выбран подход RTL-симуляции с использованием Icarus Verilog, как обеспечивающий наилучший баланс между точностью и производительностью для пре-силиконовой валидации.
...
![Схематичное представление](fault_simulator/5.1.png)
...
![Тепловая карта исходов fault-инъекций](fault_simulator/5.2.png)
...
- **Метрика B (правильная):** «сколько CFE, возникающих в самой YACCA-программе, обнаруживает YACCA» → 145/(21+145) = **87.3%**. Сопоставимо с данными Vankeirsbilck J. для ARM: YACCA_CMP показывает средний detection rate 75% на ARM Cortex-M3 (Chapter 4, Fig. 4.2).
